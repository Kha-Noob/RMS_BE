...
public class InventoryLog {
    ...
    private Double changeQuantity; // Positive for addition, negative for deduction

    @Column(nullable = false)
    private String type; // OrderDeduction, ManualAdjustment, GRN, TransferOut, TransferIn, Adjustment
